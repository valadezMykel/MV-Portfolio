...
export default function Home() {
    ...
    <>
        <PortfolioImage backgroundColor={'rgb(230,225,215)'} reversed={false} image={'IMG_1242.jpeg'} 
            text={"Hi, I'm Mykel Valadez and I help people and business' get their ideas out on the internet.  It's time for you to reach out to new customers and patrons to show them what you bring to the table."}
